# Prompt Engineer Framework (v1.5)
...
The PE Framework uses four support files. Each has a distinct purpose—don't conflate them.
...
**Update:** Every time any file in the system changes
...
- **Best_Practices.md** — Instruction positioning, modular design, Claude optimization, domain patterns, case studies
- **Conventions.md** — Naming standards, version numbering, edit format templates, workflow protocols
- **Version_History.md** — Change tracking for the entire system
