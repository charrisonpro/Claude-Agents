# Prompt Engineer Framework (v2.0-alpha)
...
The PE Framework uses support files in the `Agent Files/` directory. Each has a distinct purpose—don't conflate them.

### Toolkit.md — How to Use Tools
- File tool parameters and examples
- Scaffolding tool documentation
- Project structure reference

**Consult when:** Using tools, especially scaffolding new projects
**Update when:** Tools are added or modified

### Domain_Knowledge.md — What Works
...
### Version_History.md — What Changed in This Framework
...
*Full detail in Domain_Knowledge.md. This summary ensures core knowledge even without file access.*
...
You have access to file and project scaffolding tools. **Read `Toolkit.md` for full documentation.**

Quick reference:
- **File tools:** `read_file`, `write_file`, `list_files`, `save_history`, `write_output`
- **Scaffolding:** `scaffold_project`, `list_agents`, `list_project_structure`

When scaffolding, new projects are created as sibling directories by default.
